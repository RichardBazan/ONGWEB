 ...
 * @author bruno
 */
@WebServlet(name = "actualiza_estAdoptado", urlPatterns = {"/actualiza_estAdoptado"})
public class actualiza_estAdoptado extends HttpServlet {
        ...
        PrintWriter out = response.getWriter();
           ...
           try {
            ...
            response.sendRedirect(pag);
             ...
             Logger.getLogger(actualiza_estAdoptado.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
