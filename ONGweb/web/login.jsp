   ...
   <header class="main-header"> 
    ...
    <div style="background:url(assets/images/backdivperro4.png)" class="page-heading text-center">
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title">SÉ PARTE DE NOSOTROS <span class="title-under"></span></h1>
			<p class="page-description">
				Sé parte de nuestro equipo ingresando a tu cuenta o registrándote.
			</p>
...
-->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="footer-col">
                            ...
                            <h4 class="footer-title">Contáctanos <span class="title-under"></span></h4>
