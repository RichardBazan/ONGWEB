    ...
    <div id="wrapper" style="background: #115C9B">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Reporte de Usuarios</h1>
                </div>
                <!--End Page Header -->
            </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6" >
                                    ...
                                    <form role="form" name="frmReporteUsuario" id="frmReporteUsuario" method="POST" action="">
                                        <input type="hidden" name="cod_usu" value="<%=codigoUsuario%>"/>
                                        <iframe  src="reporteUsuariosPHP.jsp" style="height: 700px; width:1000px"></iframe>
                                    </form>
                                </div>
                            </div>
                        </div>
