    ...
    <link href="assets/plugins/dataTables/dataTables.bootstrap.css" rel="stylesheet" />
       <script langiage="javascript" type="text/javascript">
             function validar_popup() {
                var valor = document.getElementById("cboEstadoMas").value;
                
             if(valor == "#"){
                  swal("Falta seleccionar estado!","Eliga un estado por favor", "warning");
             }else{
                  
             document.frmActuMascota.submit();
...
<body>
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Estado Mascota</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             Registro Estado Mascota
                        </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <form name="frmActuMascota" method="POST" action="actualiza_estMascota">
                                    <center>
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <input type="hidden" name="codigo_mas" value="<%=request.getParameter("cod")%>">
