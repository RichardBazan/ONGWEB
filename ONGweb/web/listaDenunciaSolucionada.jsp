    ...
    <div id="wrapper" style="background: #115C9B">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Lista de Denuncias Solucionados</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                             Registros de Denuncias Solucionados
                        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                     ...
                                     <tbody>
                                         <%String descrip_den;
                                            ...
                                            for(DTO.DTODENUNCIA x:obj.readAllSolucionados()){
                                         ...
                                         <tr class="odd gradeX">
                                            ...
                                            <td><h4><b><center><%=x.getTitulo_den()%></center></b></h4><center><img src="<%=y.getFoto_den()%>" width="180" height="154">
                                             ...
                                             <td width="500" onClick="CrearEnlace('detalleMaltratoSolucionado.jsp?cod_den=<%=x.getCod_den()%>')" title="Ver más&hellip;"><br><br><br><%=descrip_den%></td>
                                            
                                             <td title="Ver comentarios&hellip;" onClick="CrearEnlace('comentariosDenunciaSolucionado.jsp?cod_den=<%=x.getCod_den()%>')"><center><br><br><a href="#"> 
